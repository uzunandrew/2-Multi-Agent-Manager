...
|------|-------|-----------|
| Parking layouts | 30% | Underground parking plans: markings, signs, parking spaces, driveways, ramps, TX equipment, slopes |
| Elevator shaft sections/plans | 25% | Vertical sections: shaft, cabin, counterweight, machine room, pit |
| Equipment layouts | 15% | Pavilion plans, security rooms, parking service rooms, utility rooms |
| Waste management plans | 15% | Waste collection room plans, hoist location, containers, removal route, shaft section |
| Tables/specifications | 10% | Tables on sheets: elevator equipment specifications, parking specifications, waste removal specifications, load tables, room schedules |
| Details | 5% | Mounting nodes, connection details, enlarged fragments |
