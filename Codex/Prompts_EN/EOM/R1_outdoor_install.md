...
Raise `norm_role` to `core` when the finding concerns mandatory burial depth, crossings, distances to utilities, protection measures, or outdoor installation per mandatory requirements.
