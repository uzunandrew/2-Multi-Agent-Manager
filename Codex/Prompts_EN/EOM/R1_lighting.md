...
Raise `norm_role` to `core` when the finding concerns emergency / escape lighting, mandatory illuminance levels, IP / environmental suitability, or mandatory control logic.
