...
| Type | Description |
|------|------------|
| Heating system schematic / axonometric view | Heating pipe routing, risers, branches, radiators, control valves |
| Heating pipe plan | Horizontal pipe routing, radiator locations, risers, underfloor heating |
| Ductwork plan | Supply/exhaust ducts, grilles, diffusers, dampers, AHUs |
| AHU schematic | Functional diagram of supply/exhaust AHU, sections, heat recovery, filters |
| Air conditioning plan | Indoor/outdoor units, refrigerant lines, drainage, VRF system |
| Connection detail | Air heater piping details, ИТП, pump groups, mixing valves |
| Equipment specification | Specifications, equipment and materials lists, airflow tables |
