...
|-----------|----------|----------------------|
| Device type/model | Exact match | Экономическое |
| Device capacity | ±5% | Экономическое |
| Number of devices | Exact match | Экономическое |
| Pipe diameter | Exact match | Экономическое |
| Number of risers | Exact match | Экономическое |
| Riser designation | Exact match | Эксплуатационное |
...
- Airflow on plan (in system label) = airflow on AHU schematic?
- Section composition on schematic matches the description in general notes?
- Air heater/cooler capacity on schematic = specification?

**3b. Ductwork:**
- Duct cross-sections on plan = cross-sections on schematic (if schematic includes sections)?
- Airflow on main duct section (plan) = total airflow per grilles?
...
- Ductwork: total length per cross-section ≈ specification?
...
4. **ГОСТ Р 21.101-2020** and **ГОСТ 21.602-2016** (heating), **ГОСТ 21.602-2016** (ventilation):
   - Title block filled
   - Sequential numbering
   - Register on first sheet
   - Legend/symbols (ГОСТ 21.205 — ductwork, ГОСТ 21.206 — piping)
...
2. System numbering does not overlap?
...
| Device capacity on plan ≠ axonometric view (> 5%) | Экономическое | 0.85 |
| Equipment model on plan ≠ specification | Экономическое | 0.85 |
| Duct cross-section on plan ≠ schematic | Экономическое | 0.85 |
| Airflow on plan ≠ airflow on schematic | Экономическое | 0.85 |
